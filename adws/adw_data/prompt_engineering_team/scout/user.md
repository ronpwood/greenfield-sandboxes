...
Your part in this run: find what `prompt` asks about, so the team builds on what is actually there. Write findings into `context_handoff_dir`, then emit your `Report` JSON.
