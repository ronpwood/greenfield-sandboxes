...
| V3 | Bb major | Bb D F | Bb + 4 = D, Bb + 7 = F; letters B-D-F |
...
### A2 — test_designer (test_design)
**Targets:** R3
**Change:** R3 cannot be asserted without an AudioContext spy; test the pitch list instead.
**Why (first principles):** the pitches are the observable contract.
**Ruling:** proposed
